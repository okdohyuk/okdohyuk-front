...
import headerToolbox from 'assets/locales/ko/header-toolbox.json';
import textCase from 'assets/locales/ko/text-case.json';
...
declare module 'i18next' {
  ...
  interface CustomTypeOptions {
    ...
    resources: {
      ...
      'header-toolbox': typeof headerToolbox;
      'text-case': typeof textCase;
    };
  }
}
