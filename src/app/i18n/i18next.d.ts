...
import textCaseConverter from 'assets/locales/ko/text-case-converter.json';
import utmBuilder from 'assets/locales/ko/utm-builder.json';
...
declare module 'i18next' {
  ...
  interface CustomTypeOptions {
    ...
    resources: {
      ...
      'text-case-converter': typeof textCaseConverter;
      'utm-builder': typeof utmBuilder;
    };
  }
}
