...
import termsData from '~/assets/datas/termsData.json';
...
export default async function TermsPage({ params }: LanguageParams) {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const { lng } = await params;

  return (
    <div className="max-w-4xl mx-auto px-4 py-12 lg:py-24">
      <h1 className="t-t-1 mb-10 text-center t-basic-1">{termsData.title}</h1>
